...
const translations = {
  en: {
    ...
    subtitle:
      "Find current NYC-area donation locations for people affected by the August 2026 Colombia earthquake. *** CALL YOUR DESIRED LOCATION TO ASK WHAT DONATIONS THEY ACCEPT, AS NEEDS CONSTANTLY CHANGE. *** ",
