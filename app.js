...
const translations = {
  ...
  es: {
    ...
    subtitle:
      "Encuentra lugares actuales de donación en el área de Nueva York para las personas afectadas por el terremoto en Colombia de agosto de 2026. *** LLAME AL CENTRO QUE ELIJA PARA PREGUNTAR QUÉ DONACIONES ACEPTAN, YA QUE LAS NECESIDADES CAMBIAN CONSTANTEMENTE. ***",
